...
export async function generateMetadata({ params }, parent) {
  return {
    ...parent,
    alternates: {
      canonical: `https://https://westgtahomes.ca/commercial/ontario/businesses-for-sale`,
    },
    openGraph: {
      images: "/favicon.ico",
    },
    title: [
      `100+ Ontario Restaurants, Land, Convenience Stores, Motels and Gas Stations for sale`,
      ,
      "New Listings",
      "WestGTAHomes.ca",
    ].join("|"),
